...
/*   Updated: 2021/11/24 18:29:28 by ibaali           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        v1.resize(1e6, "hello");
        /*------------------ ft::vectors ---------------------*/
        ft::vector<std::string> ft_v1(10, "string2"); // size 10
        ft_v1.resize(1e6, "hello");  // first resize size= 10 ==> capacity =10
        // std::cout << "resize() " << ft_v1.capacity() << " | " << ft_v1.size()  << "\n";
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        EQUAL((s1 == ft_s1 && z1 == ft_z1 && c1 == ft_c1)  && (s2 == ft_s2 && z2 == ft_z2 && c2 == ft_c2) && (s3 == ft_s3 && z3 == ft_z3));
    }
